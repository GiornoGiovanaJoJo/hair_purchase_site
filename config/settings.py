"""
Django settings for hair purchase site project.

Based on Django 5.2.8 (LTS)
Python 3.12+
"""
import os
...
# ✅ FIX #3: Changed default from True to False
DEBUG = config('DEBUG', default=False, cast=bool)

ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,4895c9d9450e.vps.myjino.ru', cast=Csv())
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'hair_app.context_processors.yandex_metrika',
            ],
        },
    },
]
...
# REST Framework
# ✅ FIX #2: Added rate limiting configuration
REST_FRAMEWORK = {
...
CSRF_TRUSTED_ORIGINS = [
    'http://4895c9d9450e.vps.myjino.ru',
    'https://4895c9d9450e.vps.myjino.ru',
    'http://localhost:8000',
    'http://127.0.0.1:8000',
]
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Hair Purchase API',
    'DESCRIPTION': 'API для сайта скупки волос',
    'VERSION': '1.0.0',
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@hair-purchase.ru')
ADMIN_EMAIL = config('ADMIN_EMAIL', default='admin@hair-purchase.ru')
